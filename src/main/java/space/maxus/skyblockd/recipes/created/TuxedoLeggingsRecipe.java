...
public class TuxedoLeggingsRecipe extends RecipeBase<ShapedRecipe> {
    @Override
    public @NotNull ShapedRecipe getRecipe() {
        ShapedRecipe rec = new ShapedRecipe(SkyblockD.getKey("tuxedo_legging_recipe"), SkyblockMaterial.TUXEDO_LEGGINGS.getItem());
        ...
        rec.setIngredient('B', new RecipeChoice.ExactChoice(SkyblockMaterial.KASMIR_LEGGINGS.getItem()));
