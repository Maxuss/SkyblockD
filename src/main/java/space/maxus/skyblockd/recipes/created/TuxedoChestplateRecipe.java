...
public class TuxedoChestplateRecipe extends RecipeBase<ShapedRecipe> {
    @Override
    public @NotNull ShapedRecipe getRecipe() {
        ShapedRecipe rec = new ShapedRecipe(SkyblockD.getKey("tuxedo_chestplate_recipe"), SkyblockMaterial.TUXEDO_CHESTPLATE.getItem());
        ...
        rec.setIngredient('B', new RecipeChoice.ExactChoice(SkyblockMaterial.KASMIR_CHESTPLATE.getItem()));
