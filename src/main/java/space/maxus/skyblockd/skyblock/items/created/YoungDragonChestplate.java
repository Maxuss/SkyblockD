...
public class YoungDragonChestplate extends SkyblockItem {
    @Override
    public @NotNull SkyblockItemConfig getConfig() {
        SkyblockItemConfig cfg = new SkyblockItemConfig(
                Material.LEATHER_CHESTPLATE, "Young Dragon Chestplate",
                SkyblockRarity.LEGENDARY, SkyblockItemType.CHESTPLATE,
                new SkyblockItemStats().setDefense(60).setStrength(50).setSpeed(100));
    ...
    public @NotNull String getSkyblockId() {
        return SkyblockD.getNamespace("young_chestplate");
    }
    ...
    public @NotNull ItemStack postInit(@NotNull ItemStack i) {
        ...
        lm.setColor(Color.fromRGB(216, 255, 209));
        i.setItemMeta(lm);
        return i;
    }
}
