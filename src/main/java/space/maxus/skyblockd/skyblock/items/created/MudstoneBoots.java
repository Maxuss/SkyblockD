...
public class MudstoneBoots extends SkyblockItem {
    @Override
    public @NotNull SkyblockItemConfig getConfig() {
        SkyblockItemConfig cfg = new SkyblockItemConfig(
                Material.LEATHER_BOOTS, "Mudstone Boots", SkyblockRarity.RARE,
                SkyblockItemType.BOOTS, new SkyblockItemStats().setHealth(25).setSpeed(10)
        );
    ...
    public @NotNull String getSkyblockId() {
        return SkyblockD.getNamespace("mudstone_boots");
    }
