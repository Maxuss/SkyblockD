...
public class UnstableDragonChestplate extends SkyblockItem {
    @Override
    public SkyblockItemConfig getConfig() {
        SkyblockItemConfig cfg = new SkyblockItemConfig(
                Material.LEATHER_CHESTPLATE, "Unstable Dragon Leggings",
                SkyblockRarity.LEGENDARY, SkyblockItemType.CHESTPLATE,
                new SkyblockItemStats().setDefense(30).setStrength(100).setSpeed(30));
    ...
    public String getSkyblockId() {
        return SkyblockD.getNamespace("unstable_chestplate");
    }
