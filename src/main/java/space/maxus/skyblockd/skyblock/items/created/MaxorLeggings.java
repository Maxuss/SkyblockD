...
public class MaxorLeggings extends SkyblockItem implements WitherPiece {
    @Override
    public SkyblockItemConfig getConfig() {
        SkyblockItemConfig cfg = new SkyblockItemConfig(
                Material.LEATHER_LEGGINGS, "Maxor's Leggings",
                SkyblockRarity.RELIC, SkyblockItemType.LEGGINGS,
                new SkyblockItemStats().setDefense(90).setAbilityDamage(10).setHealth(100).setSpeed(70));
    ...
    public String getSkyblockId() {
        return SkyblockD.getNamespace("maxor_leggings");
    }
    ...
    public ItemStack postInit(ItemStack i) {
        ...
        lm.setColor(Color.fromRGB(93, 47, 185));
