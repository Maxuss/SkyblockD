...
public class Valkyrie extends SkyblockItem implements WitherBlade {

    @Override
    public SkyblockItemConfig getConfig() {
        SkyblockItemConfig cfg = new SkyblockItemConfig(
                Material.IRON_SWORD, "Valkyrie", SkyblockRarity.RELIC,
                SkyblockItemType.SWORD, new SkyblockItemStats().setDamage(150)
                .setSpeed(50).setAbilityDamage(50).setStrength(250)
        );
        cfg.setDescription(
                Arrays.asList(
    ...
    public String getSkyblockId() {
        return SkyblockD.getNamespace("valkyrie_blade");
    }
    ...
    public ItemStack postInit(ItemStack i) {
        ...
        m.getPersistentDataContainer().set(SkyblockD.getKey("VALKYRIE"), PersistentDataType.BYTE, (byte)0);
