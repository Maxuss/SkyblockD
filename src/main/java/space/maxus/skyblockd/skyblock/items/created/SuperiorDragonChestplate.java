...
public class SuperiorDragonChestplate extends SkyblockItem {
    @Override
    public SkyblockItemConfig getConfig() {
        SkyblockItemConfig cfg = new SkyblockItemConfig(
                Material.LEATHER_CHESTPLATE, "Superior Dragon Chestplate",
                SkyblockRarity.LEGENDARY, SkyblockItemType.CHESTPLATE,
                new SkyblockItemStats().setDefense(30).setStrength(200).setHealth(70).setSpeed(50));
    ...
    public String getSkyblockId() {
        return SkyblockD.getNamespace("superior_chestplate");
    }
