...
public class GemstoneHelmet extends SkyblockItem {
    @Override
    public @NotNull SkyblockItemConfig getConfig() {
        SkyblockItemConfig cfg = new SkyblockItemConfig(
                Material.LEATHER_HELMET, "Emerald Helmet",
                SkyblockRarity.RARE, SkyblockItemType.HELMET,
    ...
    public @NotNull String getSkyblockId() {
        return SkyblockD.getNamespace("gemstone_helmet");
    }
    ...
    public @NotNull ItemStack postInit(@NotNull ItemStack i) {
        ...
        lm.setColor(Color.fromRGB(21, 194, 237));
        i.setItemMeta(m);
        return i;
    }
}
