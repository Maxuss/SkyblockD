...
public class NautilusBoots extends SkyblockItem {
    @Override
    public SkyblockItemConfig getConfig() {
        SkyblockItemConfig cfg = new SkyblockItemConfig(
                Material.LEATHER_BOOTS, "Nautilus Boots", SkyblockRarity.EPIC,
    ...
    public String getSkyblockId() {
        return SkyblockD.getNamespace("nautilus_boots");
    }
    ...
    public ItemStack postInit(ItemStack i) {
        ...
        lm.setColor(Color.fromRGB(255, 225, 212));
        i.setItemMeta(lm);
        return i;
    }
}
