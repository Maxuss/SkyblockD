...
public class DiverLeggings extends SkyblockItem {
    @Override
    public @NotNull SkyblockItemConfig getConfig() {
        return new SkyblockItemConfig(Material.GOLDEN_LEGGINGS, "Diver's Leggings",
    ...
    public @NotNull String getSkyblockId() {
        return SkyblockD.getNamespace("diver_leggings");
    }
