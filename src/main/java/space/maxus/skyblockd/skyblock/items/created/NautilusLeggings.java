...
public class NautilusLeggings extends SkyblockItem {
    @Override
    public SkyblockItemConfig getConfig() {
        SkyblockItemConfig cfg = new SkyblockItemConfig(
                Material.LEATHER_LEGGINGS, "Nautilus Leggings", SkyblockRarity.EPIC,
                SkyblockItemType.LEGGINGS, new SkyblockItemStats().setSeaCreatureChance(3)
                .setDefense(70).setHealth(10));
    ...
    public String getSkyblockId() {
        return SkyblockD.getNamespace("nautilus_leggings");
    }
    ...
    public ItemStack postInit(ItemStack i) {
        ...
        lm.setColor(Color.fromRGB(242, 222, 213));
        i.setItemMeta(lm);
        return i;
    }
}
