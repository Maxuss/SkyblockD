...
public class AtlantisChestplate extends SkyblockItem {
    @Override
    public @NotNull SkyblockItemConfig getConfig() {
        SkyblockItemConfig cfg = new SkyblockItemConfig(Material.LEATHER_CHESTPLATE, "Atlantis Tunic",
    ...
    public @NotNull String getSkyblockId() {
        return SkyblockD.getNamespace("atlantis_chestplate");
    }
    ...
    public @Nullable ItemStack postInit(ItemStack i) {
        ...
        lm.setColor(Color.fromRGB(63, 196, 161));
        i.setItemMeta(lm);
        return i;
    }
}
