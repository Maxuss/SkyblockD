...
public class WitherChestplate extends SkyblockItem implements WitherPiece {
    @Override
    public @NotNull SkyblockItemConfig getConfig() {
        SkyblockItemConfig cfg = new SkyblockItemConfig(
                Material.LEATHER_CHESTPLATE, "Wither Chestplate",
                SkyblockRarity.RELIC, SkyblockItemType.CHESTPLATE,
                new SkyblockItemStats().setDefense(80).setHealth(100));
    ...
    public @NotNull String getSkyblockId() {
        return SkyblockD.getNamespace("wither_chestplate");
    }
