...
public class MysticismSkillMap extends SkillMap {
    ...
    public List<ComplexReward> getRewardList() {
        ComplexReward stat1 = new ComplexReward(ChatColor.GOLD+"๑ Ability Damage", 3, null, 0);
        ComplexReward stat2 = new ComplexReward(ChatColor.GOLD+"๑ Ability Damage", 5, null, 0);
        ComplexReward stat3 = new ComplexReward(ChatColor.GOLD+"๑ Ability Damage", 7, null, 0);
        ComplexReward stat4 = new ComplexReward(ChatColor.GOLD+"๑ Ability Damage", 10, null, 0);
        ComplexReward item1 = new ComplexReward(ChatColor.GOLD+"๑ Ability Damage", 3, new ItemStack(Material.PHANTOM_MEMBRANE, 64), 64);
        ComplexReward item2 = new ComplexReward(ChatColor.GOLD+"๑ Ability Damage", 3, new ItemStack(Material.DRAGON_EGG, 1), 32);
        ComplexReward item3 = new ComplexReward(ChatColor.GOLD+"๑ Ability Damage", 5, new ItemStack(Material.DRAGON_BREATH, 1), 1);
        ComplexReward item4 = new ComplexReward(ChatColor.GOLD+"๑ Ability Damage", 7, new ItemStack(Material.DRAGON_HEAD, 1), 1);
        ComplexReward item5 = new ComplexReward(ChatColor.GOLD+"๑ Ability Damage", 10, new ItemStack(Material.GOLD_BLOCK, 1), 1);
